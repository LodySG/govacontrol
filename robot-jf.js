...
var board = module.exports = new five.Board({
    port: "/dev/ttyACM0",
    motorLeft: new five.Motor({ pins: { pwm: 6, dir: 5 }, invertPWM: true }), // à revoir
    motorRight: new five.Motor({ pins: { pwm: 11, dir: 10 }, invertPWM: true }), // à revoir
    move: function(speedObj) {
        if (speedObj.left > 0)
